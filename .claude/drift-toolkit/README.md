...
> **📦 Note**: This is a **distribution package** for installing drift detection in OTHER projects. If you're using drift detection in THIS project, the active system is in `.claude/hooks/`. See [INSTALL.md](INSTALL.md) for details.
